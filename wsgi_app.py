...
_log(f'wsgi_app starting — APP_ROOT={APP_ROOT}  Python={sys.version.split()[0]}')

try:
    sys.path.insert(0, APP_ROOT)

    class _PrefixMiddleware:
        """Strip /simulacrumai prefix so Flask sees clean paths."""
    ...
    application = _PrefixMiddleware(_flask_app, prefix='/simulacrumai')
